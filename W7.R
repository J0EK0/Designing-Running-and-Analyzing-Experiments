...
mwa = read.csv("/Users/joeko/Joe's/NCKU/2024Fall/Coursera/Designing-Running-and-Analyzing-Experiments/materials/avatars.csv")
View(mwa)
...
########
notes = read.csv("/Users/joeko/Joe's/NCKU/2024Fall/Coursera/Designing-Running-and-Analyzing-Experiments/materials/notes.csv")
View(notes)
...
#######
#20 joe wrong:ACD 
socialvalue = read.csv("/Users/joeko/Joe's/NCKU/2024Fall/Coursera/Designing-Running-and-Analyzing-Experiments/materials/socialvalue.csv")
View(socialvalue)
